...
const getVisitedViews = () => {
  return useStorage().getStorage("visited-views", [])
}

const setVisitedViews = (value: TagView[]) => {
  useStorage().setStorage("visited-views", value)
}

const getCachedViews = () => {
  return useStorage().getStorage("cache-tags-view", [])
}

const setCachedViews = (value: boolean) => {
  useStorage().setStorage("cache-tags-view", value)
}
